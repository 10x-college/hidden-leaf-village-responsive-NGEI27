...
პროექტის შესახებ
ეს არის ჩემი სასწავლო პროექტი, სადაც ავაწყვე "Hidden Leaf Village"-ის აკადემიის ვებ-გვერდი. მთავარი მიზანი იყო, რომ საიტი ყველა მოწყობილობაზე კარგად გამოჩენილიყო. გამოვიყენე Mobile-First მიდგომა, რაც ნიშნავს, რომ ჯერ მობილურის ვერსიაზე ვიმუშავე და მერე "გავზარდე" ის დესკტოპის ზომამდე.

რა ტექნოლოგიები გამოვიყენე?
HTML5: გამოვიყენე სემანტიკური თეგები (header, nav, section და ა.შ.), რათა კოდი უფრო გასაგები და ორგანიზებული ყოფილიყო.

CSS3: აქ გამოვიყენე Flexbox და Grid, რომ ქარდები ლამაზად დალაგებულიყო. ასევე გამოვიყენე CSS ცვლადები ფერების სამართავად.

ფონტები: Google Fonts-იდან შემოვტანე Inter ფონტი, რომელიც საიტს უფრო თანამედროვე იერს აძლევს.

SVG: ხატულებისთვის გამოვიყენე SVG ფორმატი, რომ ნებისმიერ ზომაზე ხარისხი არ დაკარგულიყო.


ჩემთვის ყველაზე რთული იყო იმის გაგება, თუ როგორ არ "გაწელილიყო" ქარდები დიდ ეკრანზე. თავიდან ყველაფერი ძალიან გაიწელა, მაგრამ მერე ვისწავლე max-width-ის გამოყენება. ამან დამეხმარა, რომ 1920px ეკრანზეც კი კონტენტი შუაში, ლამაზად დარჩენილიყო. ასევე, ბევრი ვიწვალე rem ერთეულებთან, რომ ყველაფერი პროპორციული ყოფილიყო, მაგრამ საბოლოოდ DevTools-ის დახმარებით რაღაცეები  გავასწორე არ ვიცი რამდენად სწორია ცემი საბოლოო პროექტი ვეცადე , ასევე ვერ დავაყენე ჰერო სექციის ბექრაუნდის ლოგო.

სტუდენტი: NINO GOGOBERIDZE